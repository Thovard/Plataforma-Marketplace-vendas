...
<h1 class="text-2xl font-semibold leading-tigh py-2">
    ...
    <a href="{{ route('comments.create', $user->id) }}" class="bg-blue-900 rounded-full text-white px-4 text-sm">+</a><br>
    <a href="{{ route('users.index', $user->id) }}" class="bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white px-8 py-1 text-sm">Volta</a><br>
